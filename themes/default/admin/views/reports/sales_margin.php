...
<script>
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getSalesMarginReport/?v=1' . $v) ?>',
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/sales_margin"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getSalesMarginReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSalesMarginReport/0/xls/?v=1'.$v)?>";
            return false;
        });
