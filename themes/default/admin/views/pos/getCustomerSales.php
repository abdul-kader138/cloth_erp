    ...
    <script>
        $(document).ready(function () {
            oTable = $('#POSData').dataTable({
                ...
                'sAjaxSource': '<?= admin_url('pos/getCustomerSales'.($customer_id ? '/'.$customer_id : '')) ?>',
                ...
                "aoColumns": [{
                    "bSortable": false,
                    "mRender": checkbox
                }, {"mRender": fld}, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": term_status},{"mRender": row_status}, {"mRender": pay_status}, {"bSortable": false}],
                ...
                {column_number: 8, filter_default_label: "[<?=lang('Payment_Method');?>]", filter_type: "text", data: []},
        ...
        function term_status(x) {
            if(x == 'CREDIT') {
                return '<div class="text-center"><span class="row_status label label-default"><?=lang('credit')?></span></div>';
            } else {
                return '';
            }
        }
