        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->sma->formatMoney($creditsalesamount->paid ? $creditsalesamount->paid : '0.00') . ' (' . $this->sma->formatMoney($creditsales->total ? $creditsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
            ...
            <div class="row no-print">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_hidden('total_credit_amount', $creditsalesamount); ?>
                        <?= form_hidden('total_credit_sale', $creditsales->total); ?>
