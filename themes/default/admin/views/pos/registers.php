                ...
                <table class="table table-bordered table-striped">
                    ...
                    if (!empty($registers)) {
                        foreach ($registers as $register) {
                            ...
                            echo '<td width="50px;"><a href="' . admin_url('pos/close_register_new/' . $register->user_id) . '" data-target="#myModal" data-toggle="modal"><span class="label label-danger"><i class="fa fa-times"></i> ' . lang('close_register') . '</span></a></td>';
                            echo '</tr>';
                        }
                    } else {
                        echo '<tr>';
