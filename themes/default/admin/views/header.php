...
<head>
    ...
    <link href="<?= $assets ?>styles/progress-wizard.css" rel="stylesheet"/>
                                        ...
                                        <li class="mm_products">
                                            ...
                                            <ul>
                                                ...
                                                <li id="products_details_search">
                                                    <a class="submenu"
                                                       href="<?= admin_url('products/details_search') ?>">
                                        ...
                                        <li class="mm_accounting">
                                            ...
                                            <ul>
                                                <li id="accounting_report_607">
                                                    <a class="submenu"
                                                       href="<?= admin_url('accounting/report_607'); ?>">
                                                        <i class="fa fa-th"></i><span
                                                                class="text"> <?= lang('report_607'); ?></span>
                                                    </a>
                                                </li>
                                                <li id="accounting_report_due">
                                                    <a class="submenu"
                                                       href="<?= admin_url('accounting/report_due'); ?>">
                                                        <i class="fa fa-th"></i><span
                                                                class="text"> <?= lang('report_due'); ?></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li id="system_settings_order_types">
                                                        <a href="<?= admin_url('system_settings/order_types') ?>">
                                                            <i class="fa fa-th-list"></i><span
                                                                    class="text"> <?= lang('Order_Types'); ?></span>
                                                        </a>
                                                    </li>
                                        ...
                                        <li class="mm_reports">
                                            ...
                                            <ul>
                                                ...
                                                <li id="reports_sales_margin">
                                                    <a href="<?= admin_url('reports/sales_margin') ?>">
                                                        <i class="fa fa-heart"></i><span
