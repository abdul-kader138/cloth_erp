...
class Billers extends MY_Controller
{
    ...
    function add()
    {
        ...
        if ($this->form_validation->run('companies/add') == true) {
            ...
            if($this->input->post('expire_date_proof')) $expire_date_proof=$this->sma->fsd($this->input->post('expire_date_proof'));
            if($this->input->post('expire_date_fc')) $expire_date_fc=$this->sma->fsd($this->input->post('expire_date_fc'));
            if($this->input->post('expire_date_cf')) $expire_date_cf=$this->sma->fsd($this->input->post('expire_date_cf'));
            if($this->input->post('expire_date_cn')) $expire_date_cn=$this->sma->fsd($this->input->post('expire_date_cn'));
            if($this->input->post('expire_date_sr')) $expire_date_sr=$this->sma->fsd($this->input->post('expire_date_sr'));
            if($this->input->post('expire_date_gov')) $expire_date_gov=$this->sma->fsd($this->input->post('expire_date_gov'));
            ...
            $data = array('name' => $this->input->post('name'),
                ...
                'prefix_proof' => $this->input->post('prefix_proof'),
                'authorization_number_proof' => $this->input->post('authorization_number_proof'),
                'expire_date_proof' => $expire_date_proof,
                'sequence_proof' => $this->input->post('sequence_proof'),
                'sequence_limit_proof' => $this->input->post('sequence_limit_proof'),

                'prefix_fc' => $this->input->post('prefix_fc'),
                'authorization_number_fc' => $this->input->post('authorization_number_fc'),
                'expire_date_fc' => $expire_date_fc,
                'sequence_fc' => $this->input->post('sequence_fc'),
                'sequence_limit_fc' => $this->input->post('sequence_limit_fc'),

                'prefix_cf' => $this->input->post('prefix_cf'),
                'authorization_number_cf' => $this->input->post('authorization_number_cf'),
                'expire_date_cf' => $expire_date_cf,
                'sequence_cf' => $this->input->post('sequence_cf'),
                'sequence_limit_cf' => $this->input->post('sequence_limit_cf'),

                'prefix_cn' => $this->input->post('prefix_cn'),
                'authorization_number_cn' => $this->input->post('authorization_number_cn'),
                'expire_date_cn' => $expire_date_cn,
                'sequence_cn' => $this->input->post('sequence_cn'),
                'sequence_limit_cn' => $this->input->post('sequence_limit_cn'),

                'prefix_sr' => $this->input->post('prefix_sr'),
                'authorization_number_sr' => $this->input->post('authorization_number_sr'),
                'expire_date_sr' => $expire_date_sr,
                'sequence_sr' => $this->input->post('sequence_sr'),
                'sequence_limit_sr' => $this->input->post('sequence_limit_sr'),

                'prefix_gov' => $this->input->post('prefix_gov'),
                'authorization_number_gov' => $this->input->post('authorization_number_gov'),
                'expire_date_gov' => $expire_date_gov,
                'sequence_gov' => $this->input->post('sequence_gov'),
                'sequence_limit_gov' => $this->input->post('sequence_limit_gov'),
            );
