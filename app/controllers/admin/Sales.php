...
//                }
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('H1', lang('Payment_Method'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('H' . $row, lang(strtoupper($sale->payment_method)));
                        $row++;
                    }
    ...
    function day_end_sales()
    {
        ...
        $credit_sale_result = $this->sales_model->getTodayCreditSalesReport($start_date, $end_date);
