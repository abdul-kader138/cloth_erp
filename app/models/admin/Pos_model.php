...
class Pos_model extends CI_Model
{
    ...
    public function getTodayCCSales()
    {
        ...
        $this->db->select('COUNT(' . $this->db->dbprefix('payments') . '.id) as total_cc_slips, SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'CC')->where('sales.payment_method !=','credit');
    ...
    public function getTodayCashSales()
    {
        ...
        $this->db->select('SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'cash')->where('sales.payment_method !=','credit');
    ...
    public function getTodayChSales()
    {
        ...
        $this->db->select('COUNT(' . $this->db->dbprefix('payments') . '.id) as total_cheques, SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'Cheque')->where('sales.payment_method !=','credit');
    ...
    public function getTodayPPPSales()
    {
        ...
        $this->db->select('COUNT(' . $this->db->dbprefix('payments') . '.id) as total_cheques, SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'ppp')->where('sales.payment_method !=','credit');
    ...
    public function getTodayStripeSales()
    {
        ...
        $this->db->select('COUNT(' . $this->db->dbprefix('payments') . '.id) as total_cheques, SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'stripe')->where('sales.payment_method !=','credit');
    ...
    public function getTodayAuthorizeSales()
    {
        ...
        $this->db->select('COUNT(' . $this->db->dbprefix('payments') . '.id) as total_cheques, SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'authorize')->where('sales.payment_method !=','credit');
...
//        if ($q->num_rows() > 0) {
    ...
    public function getRegisterGCSales($date, $user_id = NULL)
    {
        ...
        $this->db->select('COUNT(' . $this->db->dbprefix('payments') . '.id) as total_cheques, SUM( COALESCE( grand_total, 0 ) ) AS total, SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('paid_by', 'gift_card')->where('sales.payment_method !=','credit');
        $this->db->where('payments.created_by', $user_id);
    ...
    public function getRegisterCreditSalesAmount($date, $user_id = NULL)
    {
        if (!$date) {
            $date = $this->session->userdata('register_open_time');
        }
        ...
        $this->db->select('SUM( COALESCE( amount, 0 ) ) AS paid', FALSE)
            ->join('sales', 'sales.id=payments.sale_id', 'left')
            ->where('type', 'received')->where('payments.date >', $date)->where('sales.payment_method','credit');
        $this->db->where('payments.created_by', $user_id);
    ...
    public function getRegisterCreditSales($date, $user_id = NULL)
    {
        if (!$date) {
            $date = $this->session->userdata('register_open_time');
        }
        ...
        $this->db->select('SUM( COALESCE( total, 0 ) ) AS total', FALSE)
            ->where('sales.date >', $date)->where('sales.payment_method','credit')->group_by('id');
//        $this->db->where('payments.created_by', $user_id);
    ...
    public function getRegisterSalesAmount($date, $user_id = NULL)
    {
    ...
    public function getRegisterCashAmount($date, $user_id = NULL)
    {
        ...
        $this->db->select('SUM( COALESCE( amount, 0 ) ) AS total', FALSE)
            ->where('payments.date >', $date)->where('payments.paid_by','cash')->where('payments.type','received')->where('payments.payment_method IS NULL');
        $this->db->where('payments.created_by', $user_id);
    ...
    public function getRegisterAllSalesCash($date, $user_id = NULL)
    {
        if (!$date) {
            $date = $this->session->userdata('register_open_time');
        }
    ...
    public function getRegisterAllSalesCredit($date, $user_id = NULL)
    {
        if (!$date) {
            $date = $this->session->userdata('register_open_time');
        }
        ...
        $this->db->select('SUM( COALESCE( grand_total, 0 ) ) AS total', FALSE)
            ->where('sales.date >', $date)->where('sales.sale_status','completed')->where('sales.payment_method','credit');
        $this->db->where('sales.created_by', $user_id);
